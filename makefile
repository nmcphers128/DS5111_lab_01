...
synthetic_data.csv:
	wget "https://gist.github.com/Niarfe/25100a860cbb660150a3fec87378d8ac/raw/b280768fc7ad782c65f0e714017af2f05ba88ef2/synthetic_data.csv"
	echo "Copied the synthetic_data.csv file using wget"
